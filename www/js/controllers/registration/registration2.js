...
angular.module('app.controllers')
  ...
  .controller('registration2Ctrl', [ '$scope', 'registrationFactory', '$location', '$ionicPopup', '$translate', 'appConst', 'localStorageFactory', '$state', '$ionicHistory', '$rootScope',
    function($scope, registrationFactory, $location, $ionicPopup, $translate, appConst, localStorageFactory,$state, $ionicHistory, $rootScope) {

      var passwordPattern = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d\S]{6,}$/;

      $scope.securityQuestion1 = localStorageFactory.data[ "AppLang" ] == appConst.en ? [
      ...
      $scope.securityQuestion2 = localStorageFactory.data[ "AppLang" ] == appConst.en ? [
