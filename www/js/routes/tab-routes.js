    ...
    $stateProvider
            ...
            resolve: {
              priceAProcedurePageCtrl: function ($ocLazyLoad) {
                return $ocLazyLoad.load({
                  ...
                  files: ["js/controllers/maps/show-location-controller.js"],
                });
              },
            },
          },
      ...
      .state("tabsController.profileImage", {
        ...
        views: {
          tab5: {
            templateUrl:
              "templates/myBenefits/insuranceInfo/camera-gallery.html",
            resolve: {
              profilePageCtrl: function ($ocLazyLoad) {
                return $ocLazyLoad.load({
                  name: "profile-photo",
      ...
      .state("tabsController.planInformation", {
        ...
        views: {
          tab3: {
            templateUrl:
              "templates/myBenefits/planInformation/planInformation.html",
      ...
      .state("tabsController.insurance", {
        ...
        views: {
          tab3: {
            templateUrl:
              "templates/myBenefits/insuranceInfo/insurance-card.html",
            resolve: {
      ...
      .state("tabsController.insuranceCardPhotos", {
        ...
        views: {
          tab3: {
            templateUrl:
              "templates/myBenefits/insuranceInfo/insurance-card-photos.html",
            resolve: {
              insuranceCtrl: function ($ocLazyLoad) {
                return $ocLazyLoad.load({
